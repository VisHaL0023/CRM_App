  ...
  return (
    <HomeLayout>
      <div className="min-h-[90vh] flex flex-col items-center justify-center gap-2">
        <div
          className="bg-yellow-500 w-full text-black text-center text-3xl py-4 
        font-bold hover:bg-yellow-400 transition-all ease-in-out duration-300"
        >
          Tickets Records
          <AiOutlineDownload
        ...
        <div className="flex flex-col w-full overflow-hidden" ref={targetRef}>
          {/* Title row */}
          <div
            className="flex text-white font-bold justify-between items-center 
          gap-3 bg-purple-500 px-2 py-2 grid-cols-7"
          >
          ...
          {ticketState &&
            ticketState.ticketList.map((ticket) => {
              return (
                <div
                  key={ticket._id}
                  className="my-2 py-2 font-normal text-sm flex justify-between 
                  items-center gap-3 bg-gray-100 hover:bg-gray-400 
                  transition-all ease-in-out duration-300 text-black px-2 grid-cols-7"
                >
                  <div className="table-title basis-[8%] justify-start">
